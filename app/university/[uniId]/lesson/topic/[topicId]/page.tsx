...
import { BookOpen, ChevronLeft, Play, GraduationCap, Clock, CheckCircle, BarChart, MoveRight, Trophy } from 'lucide-react';
                ...
                <main className="mt-16 p-8">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <nav className="flex items-center gap-2 text-sm font-bold text-slate-400 mb-8 overflow-x-auto whitespace-nowrap pb-2">
                            ...
                            <ChevronLeft className="w-4 h-4 rotate-180 flex-shrink-0" />
                            <span className="text-teal-600 truncate">{topic?.name?.toUpperCase()}</span>
                        </nav>
                            ...
                            <div className="relative z-10">
                                <div className="flex items-start justify-between mb-6">
                                    <div className="flex items-baseline gap-3">
                                        <div className="bg-teal-600 px-3 py-1 rounded-lg text-[10px] font-black text-white uppercase tracking-tighter">Core Module</div>
