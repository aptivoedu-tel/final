...
import { BookOpen, MapPin, CheckCircle, Clock, ChevronDown, ChevronRight, ChevronUp, ChevronLeft, Play, Info, BarChart, GraduationCap, LogOut, Plus, FileText, X, Loader2 } from 'lucide-react';
                                                        ...
                                                        >
                                                            <div className="flex items-center gap-4">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-0.5">{topic.mcqCount || 0} Practice Questions Available</p>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    return (
                                                                        ...
                                                                        >
                                                                            <div className="flex items-center gap-4">
                                                                                ...
                                                                                <div className={`text-[9px] font-black px-1.5 py-0.5 rounded shadow-sm ${(subtopic.mcqCount || 0) > 0 ? 'bg-indigo-600 text-white' : 'bg-slate-200 text-slate-500'}`}>
                                                                                    {subtopic.mcqCount || 0} Questions
                                                                                </div>
                                                                            </div>
                                                                            <div className="flex items-center gap-3">
                                                                                {status.isMastered && (
