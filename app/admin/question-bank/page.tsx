                ...
                if (subjects) {
                    ...
                    const tree: HierarchyItem[] = subjects.map((s: any) => {
                        ...
                        const processedTopics = subjectTopics.map((t: any): HierarchyItem => {
                            ...
                            // FIX: Only count MCQs where subtopic_id is null/missing for "direct" topic count
                            const directTopicCount = allMcqs?.filter((m: any) => m.topic_id === t.id && !m.subtopic_id).length || 0;
