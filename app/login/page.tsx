            ...
            {authChecking ? (
                ...
                <div className="w-full max-w-md text-center space-y-6 animate-fade-in">
                    <div className="relative inline-block">
                        <div className="absolute inset-0 bg-[#4CAF50]/20 rounded-full blur-2xl animate-pulse"></div>
                        <div className="relative w-24 h-24 bg-white rounded-[2.5rem] flex items-center justify-center mx-auto shadow-2xl border-4 border-[#F8FAFC]">
                            <GraduationCap className="w-12 h-12 text-[#1B3A3A]" />
                        </div>
                    </div>
                    <div className="space-y-2">
                        <h1 className="text-3xl font-black text-[#1B3A3A] tracking-tighter uppercase italic">
                ...
                // Login form (only shown after auth check completes)
