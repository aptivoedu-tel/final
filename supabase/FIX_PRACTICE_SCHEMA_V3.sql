...
BEGIN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'practice_sessions' AND column_name = 'topic_id') THEN
        ALTER TABLE practice_sessions ADD COLUMN topic_id BIGINT REFERENCES topics(id);
    END IF;
...
DO $$
BEGIN
    RAISE NOTICE '✅ Practice Schema V3.1 Applied Successfully (Tables Created/Updated)';
END $$;
